...
const effectDeps = ["effect@4.0.0-beta.44"];

project.addScripts({ "codegen-client": "tsx ./scripts/codegen-cli.ts" });
project.addDeps(...effectDeps, "@effect/platform-node@4.0.0-beta.44");
project.addDevDeps("@effect/language-service", "@effect/vitest@4.0.0-beta.44");
...
const lambda = new TypeScriptLibProject({
  ...
  devDeps: [...effectDeps, "@effect/platform-node-shared@4.0.0-beta.44", "@types/aws-lambda"],
