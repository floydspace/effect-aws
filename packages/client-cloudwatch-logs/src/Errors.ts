...
export type DataAlreadyAcceptedError =
  TaggedException<DataAlreadyAcceptedException>;
...
export type InvalidSequenceTokenError =
  TaggedException<InvalidSequenceTokenException>;
...
export type UnrecognizedClientError =
  TaggedException<UnrecognizedClientException>;
