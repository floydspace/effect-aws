...
export type HumanLoopQuotaExceededError =
  TaggedException<HumanLoopQuotaExceededException>;
...
export type UnsupportedDocumentError =
  TaggedException<UnsupportedDocumentException>;
