...
export type AttributeLimitExceededError =
  TaggedException<AttributeLimitExceededException>;
export type BlockedError = TaggedException<BlockedException>;
export type ClientError = TaggedException<ClientException>;
export type ClusterContainsContainerInstancesError =
  TaggedException<ClusterContainsContainerInstancesException>;
export type ClusterContainsServicesError =
  TaggedException<ClusterContainsServicesException>;
export type ClusterContainsTasksError =
  TaggedException<ClusterContainsTasksException>;
...
export type NamespaceNotFoundError =
  TaggedException<NamespaceNotFoundException>;
export type NoUpdateAvailableError =
  TaggedException<NoUpdateAvailableException>;
export type PlatformTaskDefinitionIncompatibilityError =
  TaggedException<PlatformTaskDefinitionIncompatibilityException>;
...
export type TargetNotConnectedError =
  TaggedException<TargetNotConnectedException>;
...
export type UnsupportedFeatureError =
  TaggedException<UnsupportedFeatureException>;
