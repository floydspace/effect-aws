...
export type CertificateConflictError =
  TaggedException<CertificateConflictException>;
...
export type ConflictingResourceUpdateError =
  TaggedException<ConflictingResourceUpdateException>;
...
export type InvalidAggregationError =
  TaggedException<InvalidAggregationException>;
...
export type RegistrationCodeValidationError =
  TaggedException<RegistrationCodeValidationException>;
export type ResourceAlreadyExistsError =
  TaggedException<ResourceAlreadyExistsException>;
export type ResourceNotFoundError = TaggedException<ResourceNotFoundException>;
export type ResourceRegistrationFailureError =
  TaggedException<ResourceRegistrationFailureException>;
...
export type TaskAlreadyExistsError =
  TaggedException<TaskAlreadyExistsException>;
export type ThrottlingError = TaggedException<ThrottlingException>;
export type TransferAlreadyCompletedError =
  TaggedException<TransferAlreadyCompletedException>;
...
export type VersionsLimitExceededError =
  TaggedException<VersionsLimitExceededException>;
