...
export type CodeSigningConfigNotFoundError =
  TaggedException<CodeSigningConfigNotFoundException>;
export type CodeStorageExceededError =
  TaggedException<CodeStorageExceededException>;
export type CodeVerificationFailedError =
  TaggedException<CodeVerificationFailedException>;
...
export type EFSMountConnectivityError =
  TaggedException<EFSMountConnectivityException>;
...
export type InvalidCodeSignatureError =
  TaggedException<InvalidCodeSignatureException>;
export type InvalidParameterValueError =
  TaggedException<InvalidParameterValueException>;
export type InvalidRequestContentError =
  TaggedException<InvalidRequestContentException>;
export type InvalidRuntimeError = TaggedException<InvalidRuntimeException>;
export type InvalidSecurityGroupIDError =
  TaggedException<InvalidSecurityGroupIDException>;
...
export type PreconditionFailedError =
  TaggedException<PreconditionFailedException>;
export type ProvisionedConcurrencyConfigNotFoundError =
  TaggedException<ProvisionedConcurrencyConfigNotFoundException>;
export type RecursiveInvocationError =
  TaggedException<RecursiveInvocationException>;
...
export type SnapStartNotReadyError =
  TaggedException<SnapStartNotReadyException>;
...
export type UnsupportedMediaTypeError =
  TaggedException<UnsupportedMediaTypeException>;
